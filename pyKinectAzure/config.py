...
cwd = os.getcwd()
sys.path.append(cwd)
# from pyKinectAzure import _k4atypes,_k4atypestypes
from pyKinectAzure import _k4atypes

class config:
	def __init__(self,
				color_format=_k4atypes.K4A_IMAGE_FORMAT_COLOR_MJPG,
				color_resolution=_k4atypes.K4A_COLOR_RESOLUTION_720P,
				depth_mode=_k4atypes.K4A_DEPTH_MODE_WFOV_2X2BINNED,
				camera_fps=_k4atypes.K4A_FRAMES_PER_SECOND_30,
				synchronized_images_only=False,
				depth_delay_off_color_usec=0,
				wired_sync_mode=_k4atypes.K4A_WIRED_SYNC_MODE_STANDALONE,
	...
	def _on_change(self):
		self.current_config =  _k4atypes.k4a_device_configuration_t(self.color_format, \
